                ...
                <div className="relative px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="mt-6 prose prose-emerald prose-lg text-gray-500 mx-auto">
                        ...
                        <ul role="list">
                            ...
                            <li>
                                <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Baylor Prehealth, One Bear Place #97341 Waco, TX 76798-7108.</p>
...
For the purpose of the GDPR, Service Providers are considered Data Processors.</p>
                        ...
                        <p>Usage Data may include information such as Your Device&aposs Internet Protocol address (e.g. IP address), browser type, browser version, the pages of our Service that You visit, the time and date of Your visit, the time spent on those pages, unique device identifiers and other diagnostic data.</p>
                        ...
                        <ul role="list">
                            <li>
                                ...
                                <p>Examples: A real name, alias, postal address, unique personal identifier, online identifier, Internet Protocol address, email address, account name, driver&aposs license number, passport number, or other similar identifiers.</p>
                                <p>Collected: Yes.</p>
                            </li>
                            <li>
                            ...
                            <li>
                                ...
                                <p>Examples: Profile reflecting a person&aposs preferences, characteristics, psychological trends, predispositions, behavior, attitudes, intelligence, abilities, and aptitudes.</p>
                                <p>Collected: No.</p>
                            </li>
                        </ul>
                        ...
                        <ul role="list">
                            ...
                            <li>Information excluded from the CCPA&aposs scope, such as:
                                <ul role="list">
                                    <li>Health or medical information covered by the Health Insurance Portability and Accountability Act of 1996 (HIPAA) and the California Confidentiality of Medical Information Act (CMIA) or clinical trial data</li>
                                    <li>Personal Information covered by certain sector-specific privacy laws, including the Fair Credit Reporting Act (FRCA), the Gramm-Leach-Bliley Act (GLBA) or California Financial Information Privacy Act (FIPA), and the Driver&aposs Privacy Protection Act of 1994</li>
                                </ul>
                            </li>
                        </ul>
                        ...
                        <p>We do not knowingly collect personal information from minors under the age of 16 through our Service, although certain third party websites that we link to may do so. These third-party websites have their own terms of use and privacy policies and we encourage parents and legal guardians to monitor their children&aposs Internet usage and instruct their children to never provide information on other websites without their permission.</p>
                        ...
                        <ul role="list">
                            ...
                            <li><strong>The right not to be discriminated against.</strong> You have the right not to be discriminated against for exercising any of Your consumer&aposs rights, including by:
                                <ul role="list">
                        ...
                        <ul role="list">
                            <li>By email: <a href="/cdn-cgi/l/email-protection" className="__cf_email__" data-cfemail="81c3e0f8edeef3c3f3e8e5e6e4f2c1e3e0f8edeef3afe4e5f4">[email&#160;protected]</a></li>
                        </ul>
                        ...
                        <p>Any disclosures We provide will only cover the 12-month period preceding the verifiable request&aposs receipt.</p>
                        ...
                        <ul role="list">
                            <li>The NAI&aposs opt-out platform: <a href="http://www.networkadvertising.org/choices/" rel="external nofollow noopener noreferrer" target="_blank">http://www.networkadvertising.org/choices/</a></li>
                            <li>The EDAA&aposs opt-out platform <a href="http://www.youronlinechoices.com/" rel="external nofollow noopener noreferrer" target="_blank">http://www.youronlinechoices.com/</a></li>
                            <li>The DAA&aposs opt-out platform: <a href="http://optout.aboutads.info/?c=2&amp;lang=EN" rel="external nofollow noopener noreferrer" target="_blank">http://optout.aboutads.info/?c=2&amp;lang=EN</a></li>
                        </ul>
                        ...
                        <h1>Your California Privacy Rights (California&aposs Shine the Light law)</h1>
                        <p>Under California Civil Code Section 1798 (California&aposs Shine the Light law), California residents with an established business relationship with us can request information once a year about sharing their Personal Data with third parties for the third parties&apos direct marketing purposes.</p>
                        <p>If you&aposd like to request more information under the California Shine the Light law, and if You are a California resident, You can contact Us using the contact information provided below.</p>
                        ...
                        <p>Our Service may contain links to other websites that are not operated by Us. If You click on a third party link, You will be directed to that third party&aposs site. We strongly advise You to review the Privacy Policy of every site You visit.</p>
                        ...
                        <ul role="list">
                            <li>By email: <a href="/cdn-cgi/l/email-protection" className="__cf_email__" data-cfemail="de9cbfa7b2b1ac9cacb7bab9bbad9ebcbfa7b2b1acf0bbbaab">{email}</a></li>
                        </ul>
