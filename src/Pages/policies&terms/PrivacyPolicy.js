    ...
    return (
        <>
            <div className="relative py-16 bg-white overflow-hidden">
                ...
                <div className="relative px-4 sm:px-6 lg:px-8 space-y-12">
                    <div className="prose prose-sm max-w-2xl mx-auto">
                        <h2>
                            ...
                            <span className="mt-2 mb-6 block text-3xl text-center leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl">
                            Privacy Policy
                            </span>
                        </h2>
                        <p>
