            ...
            <div className="z-10 min-h-screen flex flex-col justify-center ">
                <div className="bg-white max-w-2xl mx-auto py-12 px-4 sm:px-6 md:py-16 lg:px-8 lg:py-20 -mt-8">
                    ...
                    <p className="mt-4 mx-auto text-gray-700">
                        We send the <span className="underline underline-offset-4 decoration-emerald-400">verification link</span> to your email, please check your inboxes and complete the sign-up process!
...
export default InitialFormComplete;
