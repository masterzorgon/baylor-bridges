...
const chair = {
    title: "Chairs",
    description: "To ensure the success of Baylor Bridges, an Alumni Board will be established to direct and govern its program goals, engagement, and outreach.",
    people: [
        {
            name: "Bill Neilson",
...
const mentorship = {
    ...
    description: "Baylor Bridges will allow meaningful engagement between healthcare alumni and prehealth undergraduates through intentional programs that facilitate professional, personal and spiritual mentorship.",
    people: [
        {
            name: "Rebecca Mulley",
...
const leadership = {
    ...
    description: "Baylor Bridges will address many issues of the global healthcare system by preparing talented and conscientious students for a career in medical leadership and service.",
    people: [
        {
...
const research = {
    ...
    description: "Baylor Bridges will encourage cutting edge research between alumni and pre-health undergraduates through selective programs that focus on academic rigor.",
    people: [
        {
            name: "Alex Crego",
            role: "Student Team Leader",
