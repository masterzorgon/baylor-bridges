                                    ...
                                    </button>
                                    {
                                        account.state === "" ?
                                            <button
                                                ...
                                                disabled={true}
                                                id="next-button"
                                                className="bg-emerald-600 hover:bg-emerald-700 cursor-not-allowed mt-6 inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-emerald-500"
                                            >
                                                Next
