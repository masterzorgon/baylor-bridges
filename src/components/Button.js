...
const Button = ({onClick, loading, disabled, children, className}) =>{
    ...
    return (
        <button
            type="button"
            className={classNames("relative text-center w-full text-sm px-4 py-2 border border-transparent font-medium rounded-md shadow-sm text-white bg-emerald-600 hover:bg-emerald-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-emerald-500 disabled:opacity-50 disabled:cursor-not-allowed", className)}
            onClick={onClick}
            disabled={disabled}
        >
            {
...
export default Button;
>>>>>>> 64bdf98f0ee391c930e5c2f614788c51246007a9
