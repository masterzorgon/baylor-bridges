...
export default function SignInRequiredModal(process) {
                    ...
                    SignIn Required
                                    ...
                                    <div className="mt-2">
                                        <p className="text-sm text-gray-500">
                                            This page is protected, and can only be accessed by signed in user. Please Sign in to visit this page
                                        </p>
                                    </div>
                                </div>
                            </div>
