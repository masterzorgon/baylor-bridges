...
const x_fields = "user_id, username, first_name, last_name, headline, prefix, role, occupation, graduate_year, graduate_semester, city, state, biography, contact_info";
